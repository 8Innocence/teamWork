...
<script>
  ...
  import ButFadeInOut from "../components/ZDS/butFadeInOut";
  ...
  import Jingao from "../components/ZDS/jinggao";
  ...
  export default {
    components: {
      ...
      Biaoqian,
      Zhedie,
      Wdlcs, Minelogin, IndexHeader, ContentLeft, CodeEditor, commoncss,ButRadioGroup, ButElRow, ButFadeInOut},
    data(){
