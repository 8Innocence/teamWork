<template>
  <div>
    <div class="Login" id="Login">
      ...
      <!-- <router-link to="/Home">登录</router-link>  ../assets/login.gif -->
      <p class="cR">copyRight@iuui登录组件 版本所有</p>
      <p class="cr_logo_text">iuui登录组件</p>
      <div class="Login_box">
        <img src="../../../static/images/pig.jpg" alt="" class="logo ">
    ...
    <code-editor :code="fadeCode"></code-editor>
  </div>
</template>
  ...
  export default {
    ...
    window.onresize();
		...
		document.getElementById('Login').addEventListener('mousemove', function(e){
			mousePosition.x = e.offsetX+50;
			mousePosition.y = e.offsetY+100;
		});
...
<style scoped>
  ...
  .Login{
    ...
    background: -webkit-linear-gradient(left top, #d42090, #4b9bfa);
    position: relative;
    top: 0;
    left: 0;
    /*bottom: 0;*/
